...
const SOUND_SIGNATURES: Record<NotificationType, Tone[]> = {
  ...
  'task-completed': [
    ...
    { freq: 659.25, start: 0.12, duration: 0.14, volume: 0.22, wave: 'triangle' },
    { freq: 783.99, start: 0.24, duration: 0.32, volume: 0.26, wave: 'triangle' },
  ],
  ...
  'pr-merged': [
    ...
    { freq: 783.99, start: 0.16, duration: 0.1, volume: 0.22, wave: 'triangle' },
    { freq: 1046.5, start: 0.24, duration: 0.4, volume: 0.26, wave: 'triangle' },
  ],
  ...
  'task-failed': [
    ...
    { freq: 523.25, start: 0.16, duration: 0.18, volume: 0.26, wave: 'triangle' },
  ...
  'task-started': [
    ...
    { freq: 659.25, start: 0.06, duration: 0.22, volume: 0.18, wave: 'triangle' },
  ],
  ...
  'stage-change': [{ freq: 587.33, start: 0, duration: 0.22, volume: 0.16, wave: 'sine' }],
}
