...
import { NotificationsPanelView, NOTIFICATIONS_PANEL_TESTID } from "./panel";
  ...
  panels: [
    {
      ...
      title: "Notifications",
      render: NotificationsPanelView,
    },
  ],
};

export { NOTIFICATIONS_PANEL_TESTID, NotificationsPanelView };
