/**
 * kody-chat agentAction — the single impl that backs the kody-direct chat.
...
import type { AgentActionEntry } from "./types";

export const DEFAULT_EXECUTABLE: AgentActionEntry = {
  slug: "kody-chat",
  title: "kody-chat",
  describe:
  ...
  tools: [
    ...
    "delete_agentResponsibility",
    "run_agentResponsibility",
    ...
    "dispatch_agent",
    "create_kody_agent",
    // ── AgentAction admin (actor-gated) ─────────────────────────────────────
    "list_agentActions",
    "read_agentAction",
    "delete_agentAction",
    "read_agentAction_creation_guide",
    "create_or_update_agentAction",
