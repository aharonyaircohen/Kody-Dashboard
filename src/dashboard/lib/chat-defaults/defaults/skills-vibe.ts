/**
 * vibe — end-to-end Vibe flow.
 * Source: system-prompt.ts § "Vibe mode" + AGENT_KODY.systemPrompt § "Hard rules"
 * (precedence overrides for vibe).
 */
...
- **Clarifying questions are rare.** Same bar as the agentIdentity.
