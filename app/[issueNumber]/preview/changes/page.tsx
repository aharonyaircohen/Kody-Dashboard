 ...
 * @ai-summary Kody dashboard with preview modal on Changes tab via URL /[n]/preview/changes.
...
export async function generateMetadata({
  ...
  if (isNaN(parsed)) return { title: "Kody" };
  return buildTaskMetadata(parsed, {
    suffix: "Changes",
    path: `/${parsed}/preview/changes`,
  });
}

export default async function KodyPreviewChangesPage({
  params,
}: {
  params: Promise<{ issueNumber: string }>;
}) {
