 ...
 * @ai-summary Kody dashboard with preview modal on Docs tab via URL /[n]/preview/docs.
...
export async function generateMetadata({
  ...
  return buildTaskMetadata(parsed, {
    suffix: "Docs",
    path: `/${parsed}/preview/docs`,
  });
}

export default async function KodyPreviewDocsPage({
  params,
}: {
  params: Promise<{ issueNumber: string }>;
}) {
