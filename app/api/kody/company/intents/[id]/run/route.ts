 ...
 * @ai-summary Dispatches the CTO company-manager action for an intent review now.
 */
...
export async function POST(
  ...
  try {
    ...
    recordAudit(req, {
      ...
      resource: id,
      detail: `manual workflow dispatch for company-manager intent ${id}`,
    });
