...
vi.mock(
  "@dashboard/lib/infrastructure/plugins/fly/runners/inventory",
  () => inventory,
);
vi.mock(
  "@dashboard/lib/infrastructure/plugins/fly/runners/inventory-server",
  () => inventoryServer,
);
vi.mock(
...
vi.mock(
  "@dashboard/lib/infrastructure/plugins/fly/terminal/bridge",
  () => bridge,
);
