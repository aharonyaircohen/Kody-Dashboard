...
Monitor tasks, manage autonomous capabilities, run agents in parallel, approve gates, review PRs and reports, and chat with Kody — all from a single web interface.
...
```
app/
  api/kody/           # Task, PR, chat, capability, secrets endpoints
...
src/dashboard/lib/
  ...
  changelog/          # Capability report aggregation
